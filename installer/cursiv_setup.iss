...
; ============================================================
; Cursiv v3.14-U21 — Chat-panel-only window; startup-freeze fix
; Produces: installer\Output\Cursiv-Setup-3.14-U21.exe
;
...
OutputDir=Output
OutputBaseFilename=Cursiv-Setup-3.14-U21
