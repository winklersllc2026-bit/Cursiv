...
; ============================================================
; Cursiv v3.14-U25 — Family letter activation ported to the chat panel
; Produces: installer\Output\Cursiv-Setup-3.14-U25.exe
;
...
OutputDir=Output
OutputBaseFilename=Cursiv-Setup-3.14-U25
