...
; ============================================================
; Cursiv v3.14-U14 — Fully-automatic bootstrap (no more silent stalls)
; Produces: installer\Output\Cursiv-Setup-3.14-U14.exe
;
...
OutputDir=Output
OutputBaseFilename=Cursiv-Setup-3.14-U14
