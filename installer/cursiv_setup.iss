...
; ============================================================
; Cursiv v3.14-U15 — Fully-automatic bootstrap (no more silent stalls)
; Produces: installer\Output\Cursiv-Setup-3.14-U15.exe
;
...
OutputDir=Output
OutputBaseFilename=Cursiv-Setup-3.14-U15
