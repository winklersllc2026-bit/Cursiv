...
; ============================================================
; Cursiv v3.14-U28 — Training Data manager: image upload, typed notes, and manual JSON
; Produces: installer\Output\Cursiv-Setup-3.14-U28.exe
;
...
OutputDir=Output
OutputBaseFilename=Cursiv-Setup-3.14-U28
