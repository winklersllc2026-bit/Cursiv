...
; ============================================================
; Cursiv v3.14-U31 — Merge a trained LoRA adapter into a real Ollama model
; Produces: installer\Output\Cursiv-Setup-3.14-U31.exe
;
...
OutputDir=Output
OutputBaseFilename=Cursiv-Setup-3.14-U31
