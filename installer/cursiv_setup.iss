...
; ============================================================
; Cursiv v3.14-U23 — Real crash handler for the "opens and closes" bug
; Produces: installer\Output\Cursiv-Setup-3.14-U23.exe
;
...
OutputDir=Output
OutputBaseFilename=Cursiv-Setup-3.14-U23
