...
; ============================================================
; Cursiv v3.14-U22 — Bundled offline field reference for the ref command
; Produces: installer\Output\Cursiv-Setup-3.14-U22.exe
;
...
OutputDir=Output
OutputBaseFilename=Cursiv-Setup-3.14-U22
