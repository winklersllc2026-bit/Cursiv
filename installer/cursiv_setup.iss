...
; ============================================================
; Cursiv v3.14-U24 — Fixes council write crash + Guardian/Watcher startup
; Produces: installer\Output\Cursiv-Setup-3.14-U24.exe
;
...
OutputDir=Output
OutputBaseFilename=Cursiv-Setup-3.14-U24
