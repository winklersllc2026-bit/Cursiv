...
; ============================================================
; Cursiv v3.14-U29 — LoRA training kickoff, Stop button, scroll fix while generating
; Produces: installer\Output\Cursiv-Setup-3.14-U29.exe
;
...
OutputDir=Output
OutputBaseFilename=Cursiv-Setup-3.14-U29
