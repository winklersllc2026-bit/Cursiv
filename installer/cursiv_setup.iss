...
; ============================================================
; Cursiv v3.14-U30 — Plain messages no longer misroute into the Code Council
; Produces: installer\Output\Cursiv-Setup-3.14-U30.exe
;
...
OutputDir=Output
OutputBaseFilename=Cursiv-Setup-3.14-U30
